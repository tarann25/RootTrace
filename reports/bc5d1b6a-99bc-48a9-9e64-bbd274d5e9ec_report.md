...
**Generated On:** 2026-09-14 09:26:01 UTC  

## 1. Executive Summary
Automated Correlation Summary: 6 events correlated across 1 user(s) (tsingh), 3 IP address(es) (198.51.100.42, 103.21.244.12, 10.0.1.50), and 3 domain(s) (login-payroll-update.com, mail.attacker-redirect.com, attacker-redirect.com). The attack chain encompasses log events from wazuh, dns_query, cloudtrail, email_gateway, web_proxy.
